...
public class TestOrderTimestampExtractInterceptor implements Interceptor {

    String timeField;

    public TestOrderTimestampExtractInterceptor(String timeField) {
    ...
    public static class TimeExtractInterceptorBuilder implements Builder {
        ...
        public Interceptor build() {
            ...
            return new TestOrderTimestampExtractInterceptor(timeField);
        }
